...
var slider_id=jQuery(this).attr('id');var slider_nav_id=jQuery(this).attr('data-slider-nav-for');var slider_conf=JSON.parse(jQuery(this).closest('.wpostahs-slider-wrp').find('.wpostahs-slider-conf').attr('data-conf'));if(typeof(slider_nav_id)!='undefined'&&slider_nav_id!=''){nav_id='.'+slider_nav_id}
if(typeof(slider_id)!='undefined'&&slider_id!=''){jQuery('.'+slider_nav_id).slick({lazyload:slider_conf.lazyload,dots:(slider_conf.dots=="true")?!0:!1,infinite:(slider_conf.loop=="true")?!0:!1,arrows:!1,speed:parseInt(slider_conf.speed),autoplay:(slider_conf.autoplay=="true")?!0:!1,fade:(slider_conf.fade=="true")?!0:!1,autoplaySpeed:parseInt(slider_conf.autoplayInterval),asNavFor:'#'+slider_id,slidesToShow:1,mobileFirst:(Wpostahs.is_mobile==1)?!0:!1,rtl:(slider_conf.rtl=="true")?!0:!1,slidesToScroll:1,adaptiveHeight:!0})}
if(typeof(slider_nav_id)!='undefined'){jQuery('#'+slider_id).slick({lazyload:slider_conf.lazyload,slidesToShow:parseInt(slider_conf.slidestoshow),slidesToScroll:1,infinite:(slider_conf.loop)=="true"?!0:!1,asNavFor:nav_id,arrows:(slider_conf.arrows)=="true"?!0:!1,dots:!1,speed:parseInt(slider_conf.speed),centerMode:(slider_conf.centermode)=="true"?!0:!1,rtl:(slider_conf.rtl=="true")?!0:!1,focusOnSelect:!0,centerPadding:'10px',responsive:[{breakpoint:768,settings:{arrows:!0,centerMode:!0,centerPadding:'10px',slidesToShow:3}},{breakpoint:480,settings:{arrows:!0,centerMode:!0,centerPadding:'10px',slidesToShow:1}}]})}})};
